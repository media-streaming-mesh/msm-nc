...
func (m *StreamMapper) ProcessCRDStream(crdData *mediastreamsv1.Streamdata) error {
	var serverProxyIP string
	var clientProxyIP string
	var serverDpGrpcClient transport.Client
	var clientDpGrpcClient transport.Client

	data := m.CRDObjToModelObj(crdData)
...
func (s *StreamMapper) CRDObjToModelObj(crdData *mediastreamsv1.Streamdata) model.StreamData {
